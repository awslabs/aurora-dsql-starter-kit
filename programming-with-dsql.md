...
1. Choose the cluster you want to connect to
1. Choose **Connect with Query Editor** and then **Connect with CloudShell**
1. Choose whether to connect as admin or with a custom database role
1. Choose **Launch in CloudShell** and **Run** in the CloudShell dialog
...
1. Select **PostgreSQL**
1. In **Connection settings/Main** tab:
...
| **Java**             | Aurora DSQL Connector for JDBC | [JDBC Connector](https://github.com/awslabs/aurora-dsql-connectors/tree/main/java/jdbc)                           |

...
1. **Configure AWS credentials** (IAM roles, access keys, or profiles)
1. **Update connection strings** to use Aurora DSQL endpoints
1. **Test connectivity** with your Aurora DSQL cluster

...
1. [Create a cluster in Aurora DSQL](https://docs.aws.amazon.com/aurora-dsql/latest/userguide/getting-started.html#getting-started-quickstart)
...
1. Choose the cluster ID of the cluster for which you want to generate an authentication token
1. Choose **Connect** and then select **Get Token**
1. Choose whether you want to connect as an `admin` or with a custom database role
1. Copy the generated authentication token and use it for connecting with SQL clients
...
1. Sign in to the AWS Console and open the Aurora DSQL console at <https://console.aws.amazon.com/dsql>
1. At the bottom left of the AWS console, choose **CloudShell**
...
1. When prompted for a password, paste the generated token
1. Press **Enter** to see the PostgreSQL prompt: `postgres=>`
